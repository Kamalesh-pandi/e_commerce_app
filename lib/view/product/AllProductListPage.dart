...
class _AllProductListPageState extends State<AllProductListPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      productController.fetchProducts(); // Fetch all products
    });
    _searchController =
                  ...
                  child: LayoutBuilder(builder: (context, constraints) {
                    return Autocomplete<Product>(
                      ...
                      fieldViewBuilder: (context, textEditingController,
                        ...
                        // Sync controllers if needed but Autocomplete handles its own.
                        // We might want to keep reference to clear it later?
                        // For now, let's just use the one provided by builder.
                        return TextField(
